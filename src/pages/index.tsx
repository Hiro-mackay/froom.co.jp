...
const Index: React.FC<{ data: any }> = ({ data }) => {
  ...
  return (
    <>
      <Head />
      <div className="tracking-wider text-gray-800 bg-orange font-main">
        <Header />
        {/* TOP Main View */}
        <section className="relative w-screen h-screen bg-white">
          <div className="w-2/3 md:w-1/2 lg:w-2/5 xl:w-1/3 inset-center">
            <svg id="TopLogoSVG" className="w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 192">
              <defs>
                <style>
                  {
        ...
        <section
          id="service"
          className="w-11/12 px-8 py-20 mb-1 ml-auto font-bold bg-white shadow-xl w-max-top-card lg:p-32"
        >
          <h2 className="pb-10 text-2xl lg:pb-16 lg:text-4xl">Service</h2>
        ...
        <section id="member" className="w-11/12 px-8 py-20 bg-white shadow-xl w-max-top-card lg:p-32">
          <h2 className="pb-10 text-2xl font-bold lg:pb-16 lg:text-4xl">About us</h2>
          <h3 className="pb-12 text-4xl font-bold lg:pb-20 lg:text-5xl">
            未来の教育を <br className="lg:hidden" />
            今作るために
          </h3>
          <div className="font-normal lg:font-bold leading-8 lg:text-xl lg:leading-10">
            <p className="pb-8">
              「教育をより良いものにするための事業をやりたい」という思いで2020年2月に立ち上げたのが、株式会社Froomです。
              <br />
              Froomには"From
              Room"「今この部屋・この場所から始めていこう」という言葉が由来で、FromとRoomの2語をつなげた造語です。
            </p>
            <div className="grid grid-cols-1 xl:grid-cols-3 gap-4">
              <img className="mt-auto mb-3 lg:mb-0 lg:order-last" src={CoreMemberPhotos} alt="Froom Member" />
